...
type NotifyKeysClient interface {
	SendKeys(ctx context.Context, in *AvailableKeysReq, opts ...grpc.CallOption) (*AvailableKeysReq, error)
}
...
func (c *notifyKeysClient) SendKeys(ctx context.Context, in *AvailableKeysReq, opts ...grpc.CallOption) (*AvailableKeysReq, error) {
	out := new(AvailableKeysReq)
...
type NotifyKeysServer interface {
	SendKeys(context.Context, *AvailableKeysReq) (*AvailableKeysReq, error)
...
func (UnimplementedNotifyKeysServer) SendKeys(context.Context, *AvailableKeysReq) (*AvailableKeysReq, error) {
